...
- **Voice Assistant hotkey** — dedicated hotkey that sends what you say straight to your AI assistant as a command, no wake word needed and no cleanup pass; highlighted text is edited in place, answers paste at a focused text cursor when auto-paste is enabled, and all other answers stream into a floating panel. You can also opt in to sending a screenshot of your current screen as context
